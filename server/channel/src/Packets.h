...
PACKET_PARSER_DECL(PartyRecruitReply);      // 0x018F
PACKET_PARSER_DECL(PartyRecruit);           // 0x0192
...
PACKET_PARSER_DECL(ItemPromo);              // 0x01C9
...
PACKET_PARSER_DECL(DiasporaBaseCapture);    // 0x02C4
PACKET_PARSER_DECL(DiasporaEnter);          // 0x02C7
...
PACKET_PARSER_DECL(UBSpectatePlayer);       // 0x038F
PACKET_PARSER_DECL(UBProceed);              // 0x0392
PACKET_PARSER_DECL(UBLeave);                // 0x0394
PACKET_PARSER_DECL(UBLottoCancel);          // 0x0398
PACKET_PARSER_DECL(UBLottoJoin);            // 0x039A
...
PACKET_PARSER_DECL(MissionLeave);           // 0x03ED
...
PACKET_PARSER_DECL(PentalphaData);          // 0x0400
...
PACKET_PARSER_DECL(DestinyBoxData);         // 0x040D
PACKET_PARSER_DECL(DestinyLotto);           // 0x0410
