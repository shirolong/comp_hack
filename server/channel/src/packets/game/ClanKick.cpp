/**
 * @file server/channel/src/packets/game/ClanKick.cpp
 * @ingroup channel
 *
 * @author HACKfrost
 *
 * @brief Request from the client to kick a character from their current clan.
 *
...
bool Parsers::ClanKick::Parse(libcomp::ManagerPacket *pPacketManager,
