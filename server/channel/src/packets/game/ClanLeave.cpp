/**
 * @file server/channel/src/packets/game/ClanLeave.cpp
 * @ingroup channel
 *
 * @author HACKfrost
 *
 * @brief Request from the client to leave their current clan.
 *
...
bool Parsers::ClanLeave::Parse(libcomp::ManagerPacket *pPacketManager,
