/**
 * @file server/channel/src/packets/game/TeamKick.cpp
 * @ingroup channel
 *
 * @author HACKfrost
 *
 * @brief Request from the client to kick a player from the player's team.
 *
...
bool Parsers::TeamKick::Parse(libcomp::ManagerPacket *pPacketManager,
