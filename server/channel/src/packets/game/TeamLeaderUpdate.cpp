/**
 * @file server/channel/src/packets/game/TeamLeaderUpdate.cpp
 * @ingroup channel
 *
 * @author HACKfrost
 *
 * @brief Request from the client to update the player's current team leader.
 *
...
bool Parsers::TeamLeaderUpdate::Parse(libcomp::ManagerPacket *pPacketManager,
    ...
    libcomp::ReadOnlyPacket& p) const
{
    ...
    request.WriteU8((int8_t)
        InternalPacketAction_t::PACKET_ACTION_GROUP_LEADER_UPDATE);
