...
ELSE()
    SET(MARIADB_URL
        URL https://github.com/comphack/mariadb/archive/comp_hack-20170520.zip
        URL_HASH SHA1=ed44bb184f638936a1e3078b4efcf6eed917615d
    )
ENDIF()
...
ExternalProject_Add(
    ...
    CMAKE_ARGS -DCMAKE_INSTALL_PREFIX:PATH=<INSTALL_DIR> "-DCMAKE_CXX_FLAGS=-std=c++11 ${SPECIAL_COMPILER_FLAGS}" "-DOPENSSL_ROOT_DIR=${OPENSSL_ROOT_DIR}" -DUSE_STATIC_RUNTIME=${USE_STATIC_RUNTIME} -DCMAKE_DEBUG_POSTFIX=d
