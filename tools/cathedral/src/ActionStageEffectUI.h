/**
 * @file tools/cathedral/src/ActionStageEffectUI.h
 * @ingroup cathedral
 *
 * @author COMP Omega <compomega@tutanota.com>
 *
 * @brief Definition for a stage effect action.
 *
...
#ifndef TOOLS_CATHEDRAL_SRC_ACTIONSTAGEEFFECTUI_H
#define TOOLS_CATHEDRAL_SRC_ACTIONSTAGEEFFECTUI_H
