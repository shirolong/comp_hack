/**
 * @file tools/cathedral/src/ActionAddRemoveStatusUI.h
 * @ingroup cathedral
 *
 * @author COMP Omega <compomega@tutanota.com>
 *
 * @brief Definition for an add/remove status action.
 *
...
#ifndef TOOLS_CATHEDRAL_SRC_ACTIONADDREMOVESTATUSUI_H
#define TOOLS_CATHEDRAL_SRC_ACTIONADDREMOVESTATUSUI_H
