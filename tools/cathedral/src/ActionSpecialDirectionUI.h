/**
 * @file tools/cathedral/src/ActionSpecialDirectionUI.h
 * @ingroup cathedral
 *
 * @author COMP Omega <compomega@tutanota.com>
 *
 * @brief Definition for a special direction action.
 *
...
#ifndef TOOLS_CATHEDRAL_SRC_ACTIONSPECIALDIRECTIONUI_H
#define TOOLS_CATHEDRAL_SRC_ACTIONSPECIALDIRECTIONUI_H
