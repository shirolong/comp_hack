/**
 * @file tools/cathedral/src/SpawnGroupList.h
 * @ingroup cathedral
 *
 * @author HACKfrost
 *
 * @brief Definition for a control that holds a list of spawn groups.
 *
...
#ifndef TOOLS_CATHEDRAL_SRC_SPAWNGROUPLIST_H
#define TOOLS_CATHEDRAL_SRC_SPAWNGROUPLIST_H
