/**
 * @file tools/cathedral/src/ActionSetNPCStateUI.h
 * @ingroup cathedral
 *
 * @author COMP Omega <compomega@tutanota.com>
 *
 * @brief Definition for a set NPC state action.
 *
...
#ifndef TOOLS_CATHEDRAL_SRC_ACTIONSETNPCSTATEUI_H
#define TOOLS_CATHEDRAL_SRC_ACTIONSETNPCSTATEUI_H
